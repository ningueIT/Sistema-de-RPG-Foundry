...
## Exemplos de Cálculo de Barreiras (Feiticeiros e Maldições)

O sistema calcula PV de paredes geradas por `Técnicas de Barreira` usando duas fórmulas:

- PV Padrão por parede = 5 + (Nível de Aptidão em Barreira × metade do Nível do Personagem)
- PV Paredes Resistentes = 10 + (Nível de Aptidão em Barreira × Nível do Personagem)
- PV Casca do Domínio = 2 × PV Padrão

Exemplo 1: Personagem Nível 4, Barreira Nível 2
- PV Padrão = 5 + (2 × floor(4/2)) = 5 + (2 × 2) = 9 PV
- PV Paredes Resistentes = 10 + (2 × 4) = 18 PV
- PV Casca do Domínio = 2 × 9 = 18 PV

Exemplo 2: Personagem Nível 7, Barreira Nível 3
- PV Padrão = 5 + (3 × floor(7/2)) = 5 + (3 × 3) = 14 PV
- PV Paredes Resistentes = 10 + (3 × 7) = 31 PV
- PV Casca do Domínio = 28 PV

No sheet da ficha esses valores aparecem em **Aptidões → Derivados** e há um botão "Criar Paredes no Mapa" que cria segmentos simples de parede em volta do token selecionado (uso minimalista para auxiliar cenas táticas).
